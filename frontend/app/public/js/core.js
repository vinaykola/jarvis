              ...
              function showComicPanel( node ) {
                ...
                */
                function getComicInfo( n, nodeArray ) {
                  ...
                  info += '<a href="http://localhost:8081/recommend?name='+n.nameid+'"><input background=#000 type=submit value=Recommend class=clouds-flat-button><span class=l></input></a></div>';
                  return info;
                }
            } //Scope.render
        } //link
